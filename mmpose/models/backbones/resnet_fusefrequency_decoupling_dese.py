...
class ResNetFuseFrequencyDecouplingDESE(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetFuseFrequencyDecouplingDESE, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        super(ResNetFuseFrequencyDecouplingDESE, self).init_weights()
...
@MODELS.register_module()
class ResNetV1dFuseFrequencyDecouplingDESE(ResNetFuseFrequencyDecouplingDESE):
