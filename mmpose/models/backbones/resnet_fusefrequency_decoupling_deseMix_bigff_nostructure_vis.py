...
class ResNetFuseFrequencyDecouplingDESEMixBigffNoStructureVis(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetFuseFrequencyDecouplingDESEMixBigffNoStructureVis, self).__init__(init_cfg)
        ...
        self.extendlayer = FrequencyModule().cuda()
        self.res_layers = []
    ...
    def init_weights(self):
        ...
        super(ResNetFuseFrequencyDecouplingDESEMixBigffNoStructureVis, self).init_weights()
...
@MODELS.register_module()
class ResNetV1dFuseFrequencyDecouplingDESEMixBigffNoStructureVis(ResNetFuseFrequencyDecouplingDESEMixBigffNoStructureVis):
...
class FrequencyModule(nn.Module):
    def __init__(self):
        super().__init__()
        self.con_begin = ConvModule(3,16,1)
        ...
        self.con_end = ConvModule(16,3,1)
    ...
    def forward(self,x):
        ...
        vis_fea(fuseFea,'ff')
        fuseFea = self.con_end(fuseFea)
        vis_fea(fuseFea,'eimg_plt')
        vis_img(fuseFea,'eimg_cv2')
        return fuseFea
