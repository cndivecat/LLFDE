...
class ResNetFuseFrequencyDecouplingDESEMixBigffTwo(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetFuseFrequencyDecouplingDESEMixBigffTwo, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        super(ResNetFuseFrequencyDecouplingDESEMixBigffTwo, self).init_weights()
...
@MODELS.register_module()
class ResNetV1dFuseFrequencyDecouplingDESEMixBigffTwo(ResNetFuseFrequencyDecouplingDESEMixBigffTwo):
...
class ExtendLayer(nn.Module):
    def __init__(self):
        ...
        # 全局特征的获取
        self.glob_conv1 = ConvModule(in_channels=16,out_channels=16,kernel_size=5,padding=2)
        ...
        self.loaclconv = ConvModule(in_channels=32,out_channels=32,kernel_size=1,act_cfg=None)
        self.Lendconv = ConvModule(in_channels=32,out_channels=3,kernel_size=1,act_cfg=None)
    ...
    def forward(self,x):
        ...
        fea_glob = self.glob_conv3(self.glob_conv2(self.glob_conv1(fea_lay1_2)))
