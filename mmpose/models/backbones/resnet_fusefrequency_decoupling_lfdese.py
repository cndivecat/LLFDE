...
class ResNetFuseFrequencyDecouplingLFDESE(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetFuseFrequencyDecouplingLFDESE, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        super(ResNetFuseFrequencyDecouplingLFDESE, self).init_weights()
...
@MODELS.register_module()
class ResNetV1dFuseFrequencyDecouplingLFDESE(ResNetFuseFrequencyDecouplingLFDESE):
...
class FrequencyModule(nn.Module):
    ...
    def forward(self,x):
        ...
        vis_fea(feaLF_enhanced,'elf')
        # fuseFea = self.feamix(feaLF_enhanced,feaHF_enhanced)
        # fuseFea = feaLF_enhanced+feaHF_enhanced
        return feaLF_enhanced
