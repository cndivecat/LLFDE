...
class ResNetCPN(BaseBackbone):
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetCPN, self).__init__(init_cfg)
        ...
        self.global_net = globalNet(channel_settings, [64,48], 14)
        self.refine_net = refineNet(channel_settings[-1], [64,48], 14)
    ...
    def init_weights(self):
        ...
        super(ResNetCPN, self).init_weights()
    ...
    def forward(self, x):
        ...
        for i, layer_name in enumerate(self.res_layers):
            ...
            if i in self.out_indices:
                outs.append(x)
        global_fms, _ = self.global_net(outs)
        refine_out = self.refine_net(global_fms)
        return tuple(refine_out)
