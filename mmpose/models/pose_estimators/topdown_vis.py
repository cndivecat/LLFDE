...
class TopdownPoseEstimatorVis(BasePoseEstimator):
    ...
    def predict(self, inputs: Tensor, data_samples: SampleList) -> SampleList:
        ...
        for i in range(len(results)):
            ...
            kpt_score_thr=0.2
            img = imshow_keypoints(img, pose_result,kpt_score, skeleton,kpt_score_thr, pose_kpt_color, pose_link_color, 
                             radius=4,
                             thickness=1)
            ...
            img_name = os.path.join(file_path,"un/" + str(i)+'_' + img_name)
